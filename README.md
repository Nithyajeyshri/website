...
<head>
  ...
  <title>Speicy Fest - Restaurant Project</title>
  <style>
    :root{
      --primary: #E7634A;
      --secondary: #0E6B66;
...
<body>
  <header>
    <div class="nav container">
      <div class="brand">
        ...
        <div>
          <div style="font-weight:800">Spiecy Fest</div>
  ...
  <main class="container">
    ...
    <section id="menu" style="margin-top:28px">
      <h2>Our Menu</h2>
      <p>We display 6 popular items below</p>
      <div class="grid">
        <div class="card">
          <img class="food-img" src="pizza-2.webp" alt="Margherita pizza">
        ...
        <div class="card">
          <img class="food-img" src="paneer-butter-masala.jpg" alt="Butter Masala">
        ...
        <div class="card">
          <img class="food-img" src="Burger.webp" alt="Classic Burger">
        ...
        <div class="card">
          ...
          <div class="food-title">Ghee Dosa</div>
          <div class="food-desc">Ghee Roast Dosa is a beloved South Indian delicacy, renowned for its crispy texture, rich flavor, and aromatic ghee infusion. Originating from the coastal regions of Karnataka, this variant of dosa stands out due to its generous use of ghee (clarified butter) during cooking, which imparts a distinct nutty taste and golden hue.</div>
          <div class="price">₹ 120</div>
        </div>
        <div class="card">
          <img class="food-img" src="cold-coffee.jpg" alt="cold coffee">
          <div class="food-title">cold coffee</div>
          <div class="food-desc">Cold Coffee is a refreshing, creamy and cold beverage made by blending instant coffee, warm water, chilled milk, sugar and ice cubes. In this easy homemade recipe, Iced Coffee is whipped up in minutes with just a few pantry staples and no fancy equipment.</div>
...
<body>
  ...
  <div class="team-container">
    <div class="team-card">
      <img src="img1.jpg" alt="Admin 1">
      <h3>Ann Patchett</h3>
      <p>Restaurant Manager</p>
    </div>

    <div class="team-card">
      <img src="img2.jpg" alt="Admin 2">
      <h3>Thomas Pynchon</h3>
      <p>Head Chef</p>
    </div>

    <div class="team-card">
      <img src="img3.jpg" alt="Admin 3">
      <h3>Anne Tyler</h3>
      <p>Assistant Chef</p>
    </div>

    <div class="team-card">
      <img src="img4.webp" alt="Admin 5">
      <h3>David Mitchell</h3>
      <p>Marketing Head</p>
    </div>

    <div class="team-card">
      <img src="img5.avif" alt="Admin 6">
      <h3>Zadie Smith</h3>
      <p>HR Manager</p>
    </div>
  </div>
    ...
    <section id="contact" style="margin-top:28px">
      ...
      <div class="contact-card">
        <div>
          <h3>Address</h3>
          <p class="small">Spicy Fest<br>27 gandhi street,brough road,chennai-600021</p>
          <h3>Phone</h3>
          <p class="small">+91 65478 98356</p>
          <h3>Email</h3>
          <p class="small">contact@Spicy fest.myres</p>
        </div>
        <div>
...
```
# OUTPUT:
<img width="1898" height="661" alt="Screenshot 2025-12-26 092839" src="https://github.com/user-attachments/assets/7f86340e-7cb0-461c-81bc-7ddb0b2f679a" />
<img width="1896" height="908" alt="Screenshot 2025-12-26 092911" src="https://github.com/user-attachments/assets/e6b7ce67-73d8-4a57-ba9c-4e2e9330bfbc" />
<img width="1901" height="911" alt="Screenshot 2025-12-26 092933" src="https://github.com/user-attachments/assets/d23afde3-3cee-43fa-a787-9e1625a5fcdf" />
<img width="1899" height="737" alt="Screenshot 2025-12-26 092951" src="https://github.com/user-attachments/assets/072e05c0-7a67-44b5-ac61-b0fd455ce5c1" />
# RESULT:
